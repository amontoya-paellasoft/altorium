...
export const MOCK_MESSAGES: MessageInterface[] = [
...

  {
    ...
    to: 'all',
    visibility: 'public',
    text: 'El flujo principal cierra hoy. Solo queda validar el fix del reenvío.',
    timeStamp: new Date('2026-04-29T09:00:00'),
  },
  {
    id: 2,
    from: 'qa',
    to: 'all',
    visibility: 'public',
    text: 'Detecto fallo al retroceder y reenviar. El estado no se resetea correctamente.',
    timeStamp: new Date('2026-04-29T10:15:00'),
  },
  {
    id: 3,
    from: 'be',
    to: 'all',
    visibility: 'public',
    text: 'Confirmado. El backend acepta reenvíos con estado inválido. Lo corrijo.',
  ...
  },
  {
    ...
    to: 'all',
    visibility: 'public',
    text: 'Desde frontend también puedo bloquear el botón si el estado no es válido.',
    timeStamp: new Date('2026-04-29T11:20:00'),
  },
  {
    id: 5,
    from: 'be',
    to: 'all',
    visibility: 'public',
    text: 'Fix aplicado. Ahora devuelve 409 si el estado no es correcto.',
    timeStamp: new Date('2026-04-29T13:00:00'),
  },
  {
    id: 6,
    from: 'qa',
    to: 'all',
    visibility: 'public',
    text: 'Verificado. El bug ya no se reproduce.',
  ...
  },
  {
    ...
    to: 'all',
    visibility: 'public',
    text: 'Perfecto. Cerramos este punto y seguimos.',
    timeStamp: new Date('2026-04-30T10:00:00'),
  },


  // ÚLTIMOS 3 MESES (feb–abr)

  {
    ...
    to: 'all',
    visibility: 'public',
    text: 'Simplifico la lógica del paso tres. Había demasiados estados intermedios.',
    timeStamp: new Date('2026-03-10T15:20:00'),
  },
  {
    id: 9,
    from: 'be',
    to: 'all',
    visibility: 'public',
    text: 'Añado validaciones en backend para evitar estados inconsistentes.',
  ...
  },
  {
    ...
    to: 'all',
    visibility: 'public',
    text: 'Con estos cambios el flujo es estable en todos los casos probados.',
  ...
  },
  {
    ...
    to: 'all',
    visibility: 'public',
    text: 'Buen avance. Pasamos a fase de validación completa.',
    timeStamp: new Date('2026-03-15T12:00:00'),
  },


  // ÚLTIMOS 6 MESES (nov–ene)

  {
    ...
    to: 'di',
    visibility: 'private',
    text: 'Usuarios reportan confusión en el paso dos. Necesitamos simplificarlo.',
  ...
  },
  {
    ...
    to: 'pm',
    visibility: 'private',
    text: 'El problema es que pedimos demasiada información de golpe. Propongo dividir el paso.',
  ...
  },
  {
    ...
    to: 'di',
    visibility: 'private',
    text: 'Ok, pero necesito validar el flujo antes de pasarlo a frontend.',
    timeStamp: new Date('2026-01-12T12:30:00'),
  },
  {
    id: 15,
    from: 'be',
    to: 'fe',
    visibility: 'private',
    text: 'El endpoint de submit valida estado. Si no es correcto devuelve 409.',
  ...
  },
  {
    ...
    to: 'be',
    visibility: 'private',
    text: 'El formato de error no es consistente con otros endpoints.',
  ...
  },
  {
    ...
    to: 'qa',
    visibility: 'private',
    text: 'Lo normalizo en toda la API.',
  ...
  },
  {
    ...
    to: 'be',
    visibility: 'private',
    text: 'Confirmado. Todo consistente.',
  ...
  },
  {
    ...
    to: 'be',
    visibility: 'private',
    text: 'Integro manejo de errores en UI con opción de reiniciar flujo.',
